...
if (manifest.manifest_version !== 3 || manifest.version !== '0.2.0') throw new Error('Unexpected manifest');
for (const file of ['background.js', 'app.html', 'app.css', 'app.js', 'browser.js', 'page.js', 'weeks.js', 'demo.js']) {
